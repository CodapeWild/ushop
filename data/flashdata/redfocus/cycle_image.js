...
function show_flash() {
  ...
  document.getElementById("flash_cycle_image").innerHTML =
    ...
    total_height +
    '">' +
    '<param name="allowScriptAccess" value="sameDomain"><param name="movie" value="data/flashdata/redfocus/redfocus.swf"><param name="quality" value="high"><param name="bgcolor" value="#F0F0F0">' +
    ...
    text_height +
    '">' +
    '<embed src="data/flashdata/redfocus/redfocus.swf" FlashVars="pics=' +
    pics +
    "&links=" +
    links +
    "&texts=" +
