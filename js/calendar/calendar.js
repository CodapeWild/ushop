...
Calendar.prototype.create = function (_par) {
  ...
  if (version >= 5.5 && document.body.filters) {
    div.innerHTML =
      '<iframe src="javascript:false" id="compareFrame" style=" position:absolute; top:0px; left:0px;width:245px; visibility:inherit;height:172px; z-index:-1;filter="progid:DXImageTransform.Microsoft.Alpha(style=0,opacity=0)";></iframe>';
  }
...
function showCalendar(id, format, showsTime, showsOtherMonths, selbtn) {
  ...
  var btn_el =
    typeof selbtn == "object" ? selbtn : document.getElementById(selbtn);
