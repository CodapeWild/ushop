...
VALUES (
  ...
  (
    ...
    'goods_booking',
    1,
    'Reply to goods booking',
    'Dear{$user_name}.Hello！</br></br>{$dispose_note}</br></br>the link of goods you refered</br></br><a href="{$goods_link}" target="_blank">{$goods_name}</a></br><br>{$shop_name} </br>{$send_date}',
    0,
    0,
    'template'
  ),
  (
    ...
    1,
    'Reply to message',
    'Dear{$user_name}.Hello！</br></br>For your message：</br>{$message_content}</br></br>the admin replyed as follow：</br>{$message_note}</br></br>you can back to shop to communicate with the seller anytime you want.</br>{$shop_name}</br>{$send_date}',
    0,
    0,
    'template'
  ),
  (
    ...
    1,
    'Reply to comment',
    'Dear{$user_name}.Hello！</br></br>For your comment：</br>“{$comment}”</br></br>the admin replyed as follow：</br>“{$recomment}”</br></br>you can back to shop to communicate with the seller anytime you want.</br>{$shop_name}</br>{$send_date}',
    0,
    0,
    'template'
  );
...
VALUES (1, 0, 'shop_info', 'group', '', '', '', '1'),
  ...
  (
    ...
    '',
    '',
    'Users shall make public announcement！',
    '1'
  ),
  (
    121,
...
VALUES (
    ...
    3,
    '',
    'Online information classification',
    50,
    1
  );
