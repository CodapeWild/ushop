...
/*------------------------------------------------------ */ elseif ($_REQUEST['act'] == 'insert' || $_REQUEST['act'] == 'update') {
  ...
  if ($is_insert) {
    if ($code == '') {
      $sql = "INSERT INTO " . $ecs->table('goods') . " (goods_name, goods_name_style, goods_sn,wide_href, " .
        ...
        "VALUES ('$_POST[goods_name]', '$goods_name_style', '$goods_sn','$wide_href', '$catgory_id', " .
