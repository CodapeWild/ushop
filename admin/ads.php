...
/*------------------------------------------------------ */ elseif ($_REQUEST['act'] == 'insert') {
  ...
  /* 如果添加的广告是Flash广告 */ elseif ($_POST['media_type'] == '1') {
  ...
  /* 如果广告类型为代码广告 */ elseif ($_POST['media_type'] == '2') {
  ...
  /* 广告类型为文本广告 */ elseif ($_POST['media_type'] == '3') {
