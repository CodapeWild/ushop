...
/*------------------------------------------------------ */ elseif ($_REQUEST['act'] == 'info') {
  ...
  /* 打印快递单 */ elseif (isset($_GET['shipping_print'])) {
    //$smarty->assign('print_time',   local_date($_CFG['time_format']));
    //发货地址所在地
    $region_array = array();
...
/*------------------------------------------------------ */ elseif ($_REQUEST['act'] == 'operate') {
  ...
  /* 收货确认 */ elseif (isset($_POST['receive'])) {
  ...
  /* 发货单删除 */ elseif (isset($_REQUEST['remove_invoice'])) {
    // 删除发货单
  ...
  /* 退货单删除 */ elseif (isset($_REQUEST['remove_back'])) {
