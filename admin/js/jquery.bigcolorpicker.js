  ...
  var bigColorPicker = new (function () {
    ...
    this.showPicker = function (callback, engine, sideLength_) {
      ...
      this.getAllColorArray = function () {
        ...
        //计算第一列的数组
        var mixColorArray = [];
        var blackWhiteGradientArray = gradientColor(
          new RGB(0, 0, 0),
          new RGB(255, 255, 255)
        );
        ...
        cornerColorArray.push(
          generateBlockcornerColor(0),
        ...
        for (var i = 0; i < cornerColorArray.length; i++) {
          var startArray = gradientColor(
            cornerColorArray[i][0][0],
            cornerColorArray[i][0][1]
          );
          var endArray = gradientColor(
            cornerColorArray[i][1][0],
      ...
      if (engine == "L") {
        ...
        if (defaultSectionsWidth < minSectionsWidth) {
          $("#bigSections li,#bigLayout")
            .width(minSectionsWidth / (sideLength * 3 + 2) - 2)
          ...
          $("#bigSections")
            .width(defaultSectionsWidth)
            .height(sideLength * 2 * 11);
          $("#bigpicker")
            .width(defaultSectionsWidth + 5)
      ...
      $(this).bind("click", function (event) {
        ...
        $("#bigLayout")
          .css({ left: bigSectionsP.left, top: bigSectionsP.top })
          .show();
      });
    };
    ...
    function gradientColor(startColor, endColor) {
      ...
      for (var i = 1; i < sideLength - 1; i++) {
        gradientArray[i] = new RGB(
          startColor.r + i * averageR,
          startColor.g + i * averageG,
          startColor.b + i * averageB
        );
      }
