    ...
    <div class="boxCenterList clearfix" style="height:1%;">
      <ul class="comments">
        <?php if ($this->_var['comments']) : ?>
          ...
          ?>
              <li class="word">
                <font class="f2"><?php if ($this->_var['comment']['username']) : ?><?php echo htmlspecialchars($this->_var['comment']['username']); ?><?php else : ?><?php echo $this->_var['lang']['anonymous']; ?><?php endif; ?></font>
                <font class="f3">( <?php echo $this->_var['comment']['add_time']; ?> )</font><br />
                ...
                <?php if ($this->_var['comment']['re_content']) : ?>
                  <p>
                    <font class="f1"><?php echo $this->_var['lang']['admin_username']; ?></font><?php echo $this->_var['comment']['re_content']; ?>
                  </p>
                <?php endif; ?>
              </li>
              <?php endforeach;
        ...
        <form name="selectPageForm" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="get">
          <?php if ($this->_var['pager']['styleid'] == 0) : ?>
            <div id="pager">
              ...
              <?php $_from = $this->_var['pager']['search'];
              if (!is_array($_from) && !is_object($_from)) {
                settype($_from, 'array');
              };
              $this->push_vars('key', 'item_0_35149200_1609942465');
              if (count($_from)) :
                foreach ($_from as $this->_var['key'] => $this->_var['item_0_35149200_1609942465']) :
              ?>
                  <input type="hidden" name="<?php echo $this->_var['key']; ?>" value="<?php echo $this->_var['item_0_35149200_1609942465']; ?>" />
                  <?php endforeach;
              endif;
              unset($_from); ?><?php $this->pop_vars();; ?>
            </div>
          <?php else : ?>
            ...
            <div id="pager" class="pagebar">
              ...
              <?php $_from = $this->_var['pager']['page_number'];
              if (!is_array($_from) && !is_object($_from)) {
                settype($_from, 'array');
              };
              $this->push_vars('key', 'item_0_35157700_1609942465');
              if (count($_from)) :
                foreach ($_from as $this->_var['key'] => $this->_var['item_0_35157700_1609942465']) :
              ?>
                  <?php if ($this->_var['pager']['page'] == $this->_var['key']) : ?>
                    <span class="page_now"><?php echo $this->_var['key']; ?></span>
                  <?php else : ?>
                    <a href="<?php echo $this->_var['item_0_35157700_1609942465']; ?>">[<?php echo $this->_var['key']; ?>]</a>
                  <?php endif; ?>
                  <?php endforeach;
              endif;
              unset($_from); ?><?php $this->pop_vars();; ?>
                  ...
                  <?php if ($this->_var['pager']['page_kbd']) : ?>
                    ...
                    $this->push_vars('key', 'item_0_35167400_1609942465');
                    if (count($_from)) :
                      foreach ($_from as $this->_var['key'] => $this->_var['item_0_35167400_1609942465']) :
                    ?>
                        <input type="hidden" name="<?php echo $this->_var['key']; ?>" value="<?php echo $this->_var['item_0_35167400_1609942465']; ?>" />
                        <?php endforeach;
                    endif;
                    unset($_from); ?><?php $this->pop_vars();; ?>
...
<script type="text/javascript">
  //<![CDATA[
  <?php $_from = $this->_var['lang']['cmt_lang'];
  if (!is_array($_from) && !is_object($_from)) {
    settype($_from, 'array');
  };
  $this->push_vars('key', 'item_0_35179700_1609942465');
  if (count($_from)) :
    foreach ($_from as $this->_var['key'] => $this->_var['item_0_35179700_1609942465']) :
  ?>
      var <?php echo $this->_var['key']; ?> = "<?php echo $this->_var['item_0_35179700_1609942465']; ?>";
      <?php endforeach;
  endif;
  unset($_from); ?><?php $this->pop_vars();; ?>
