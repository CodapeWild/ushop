<form name="selectPageForm" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="get">
  <?php if ($this->_var['pager']['styleid'] == 0) : ?>
    <div id="pager">
      ...
      $this->push_vars('key', 'item_0_36557700_1574402903');
      if (count($_from)) :
        foreach ($_from as $this->_var['key'] => $this->_var['item_0_36557700_1574402903']) :
      ?>
          <?php if ($this->_var['key'] == 'keywords') : ?>
            <input type="hidden" name="<?php echo $this->_var['key']; ?>" value="<?php echo urldecode($this->_var['item_0_36557700_1574402903']); ?>" />
          <?php else : ?>
            <input type="hidden" name="<?php echo $this->_var['key']; ?>" value="<?php echo $this->_var['item_0_36557700_1574402903']; ?>" />
          <?php endif; ?>
          <?php endforeach;
      endif;
  ...
  <?php else : ?>
    ...
    <div id="pager" class="pagebar">
      ...
      <?php if ($this->_var['pager']['page_count'] != 1) : ?>
        ...
        $this->push_vars('key', 'item_0_36576900_1574402903');
        if (count($_from)) :
          foreach ($_from as $this->_var['key'] => $this->_var['item_0_36576900_1574402903']) :
        ?>
            <?php if ($this->_var['pager']['page'] == $this->_var['key']) : ?>
              <span class="page_now"><?php echo $this->_var['key']; ?></span>
            <?php else : ?>
              <a href="<?php echo $this->_var['item_0_36576900_1574402903']; ?>">[<?php echo $this->_var['key']; ?>]</a>
            <?php endif; ?>
            <?php endforeach;
        endif;
        unset($_from); ?><?php $this->pop_vars();; ?>
          ...
          <?php if ($this->_var['pager']['page_kbd']) : ?>
            ...
            $this->push_vars('key', 'item_0_36588000_1574402903');
            if (count($_from)) :
              foreach ($_from as $this->_var['key'] => $this->_var['item_0_36588000_1574402903']) :
            ?>
                <?php if ($this->_var['key'] == 'keywords') : ?>
                  <input type="hidden" name="<?php echo $this->_var['key']; ?>" value="<?php echo urldecode($this->_var['item_0_36588000_1574402903']); ?>" />
                <?php else : ?>
                  <input type="hidden" name="<?php echo $this->_var['key']; ?>" value="<?php echo $this->_var['item_0_36588000_1574402903']; ?>" />
                <?php endif; ?>
                <?php endforeach;
            endif;
            unset($_from); ?><?php $this->pop_vars();; ?>
