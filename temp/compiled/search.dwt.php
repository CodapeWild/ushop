  ...
  <div class="block clearfix">
                ...
                <table border="0" align="center" cellpadding="3">
                  ...
                  <tr>
                    ...
                    <td><select name="category" id="select" style="border:1px solid #ccc;">
                        <option value="0"><?php echo $this->_var['lang']['all_category']; ?></option><?php echo $this->_var['cat_list']; ?>
                      </select>
                    </td>
                  </tr>
                  <tr>
                  ...
                  <?php if ($this->_var['goods_type_selected'] > 0) : ?>
                    <?php $_from = $this->_var['goods_attributes'];
                        ...
                        <?php if ($this->_var['item']['type'] == 2) : ?>
                          <tr>
                            ...
                            <td colspan="3"><input name="attr[<?php echo $this->_var['item']['id']; ?>][from]" class="inputBg" value="<?php echo $this->_var['item']['value']['from']; ?>" type="text" size="5" maxlength="5" />
                              -
                              <input name="attr[<?php echo $this->_var['item']['id']; ?>][to]" value="<?php echo $this->_var['item']['value']['to']; ?>" class="inputBg" type="text" maxlength="5" />
                            </td>
                          </tr>
                        <?php endif; ?>
                    ...
                    unset($_from); ?><?php $this->pop_vars();; ?>
                      ...
                      <tr>
                        <td colspan="4" align="center"><input type="hidden" name="action" value="form" />
                          <input type="submit" name="Submit" class="bnt_blue_1" value="<?php echo $this->_var['lang']['button_search']; ?>" />
                        </td>
                      </tr>
                </table>
              </form>
            ...
            <h3>
              ...
              <?php if ($this->_var['goods_list']) : ?>
                <form action="search.php" method="post" class="sort" name="listform" id="form">
                  ...
                  <select name="sort" style=" *margin-top:6px">
                  ...
                  <input type="image" name="imageField" src="themes/ecmoban_benlai2015/images/bnt_go.gif" alt="go" />
              ...
              <form action="compare.php" method="post" name="compareForm" id="compareForm" onsubmit="return compareGoods(this);">
                <?php if ($this->_var['pager']['display'] == 'list') : ?>
                  <div class="goodsList">
                    ...
                    $this->_foreach['goods_list'] = array('total' => count($_from), 'iteration' => 0);
	...
	-->
              ...
              <script type="text/javascript">
                <?php $_from = $this->_var['lang']['compare_js'];
                if (!is_array($_from) && !is_object($_from)) {
                  settype($_from, 'array');
                };
                $this->push_vars('key', 'item');
