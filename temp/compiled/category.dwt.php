          ...
          <div class="box_1">
            ...
            <?php if ($this->_var['brands']['1']) : ?>
              <div class="screeBox">
                ...
                <?php $_from = $this->_var['brands'];
                if (!is_array($_from) && !is_object($_from)) {
                  settype($_from, 'array');
                };
                $this->push_vars('', 'brand');
                if (count($_from)) :
            ...
            <?php if ($this->_var['price_grade']['1']) : ?>
              <div class="screeBox">
                ...
                <?php $_from = $this->_var['price_grade'];
                if (!is_array($_from) && !is_object($_from)) {
                  settype($_from, 'array');
                };
                $this->push_vars('', 'grade');
                if (count($_from)) :
            ...
            <?php endif; ?>
            <?php $_from = $this->_var['filter_attr_list'];
            if (!is_array($_from) && !is_object($_from)) {
              settype($_from, 'array');
            };
            $this->push_vars('', 'filter_attr_0_35938900_1574402903');
            if (count($_from)) :
              foreach ($_from as $this->_var['filter_attr_0_35938900_1574402903']) :
            ?>
                <div class="screeBox">
                  <strong><?php echo htmlspecialchars($this->_var['filter_attr_0_35938900_1574402903']['filter_attr_name']); ?> :</strong>
                  <?php $_from = $this->_var['filter_attr_0_35938900_1574402903']['attr_list'];
                  if (!is_array($_from) && !is_object($_from)) {
                    settype($_from, 'array');
                  };
                  $this->push_vars('', 'attr');
