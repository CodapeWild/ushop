          ...
          <div class="userCenterBox boxCenterList clearfix" style="_height:1%;">
            ...
            <?php if ($this->_var['action'] == 'default') : ?>
              ...
              <div style="margin:5px 0; border:1px solid #f7dd98;padding:10px 20px; background-color:#fffad5;">
                <img src="themes/ecmoban_benlai2015/images/note.gif" alt="note" />&nbsp;<?php echo $this->_var['user_notice']; ?>
              </div>
              <br /><br />
              ...
              <div class="f_r" style="width:350px;">
                ...
                unset($_from); ?><?php $this->pop_vars();; ?>
                    ...
                    <?php if ($this->_var['info']['shipped_order']) : ?>
                      ...
                      <?php $_from = $this->_var['info']['shipped_order'];
                      if (!is_array($_from) && !is_object($_from)) {
                        settype($_from, 'array');
                      };
                      $this->push_vars('', 'item');
            ...
            <?php if ($this->_var['action'] == 'message_list') : ?>
              ...
              <div class="blank"></div>
              <?php $_from = $this->_var['message_list'];
              if (!is_array($_from) && !is_object($_from)) {
                settype($_from, 'array');
              };
              $this->push_vars('key', 'message');
              if (count($_from)) :
              ...
              unset($_from); ?><?php $this->pop_vars();; ?>
                    ...
                    <table width="100%" border="0" cellpadding="3">
                      <?php if ($this->_var['order_info']) : ?>
                        <tr>
                          ...
                          <td>
                            <a href="<?php echo $this->_var['order_info']['url']; ?>"><img src="themes/ecmoban_benlai2015/images/note.gif" /><?php echo $this->_var['order_info']['order_sn']; ?></a>
                      ...
                      <?php else : ?>
                        <tr>
                          ...
                          <td><input name="msg_type" type="radio" value="0" checked="checked" />
                            ...
                            <?php echo $this->_var['lang']['type']['4']; ?>
                          </td>
                        </tr>
                      <?php endif; ?>
                      <tr>
                ...
                <?php if ($this->_var['action'] == 'comment_list') : ?>
                  ...
                  <div class="blank"></div>
                  <?php $_from = $this->_var['comment_list'];
                  if (!is_array($_from) && !is_object($_from)) {
                    settype($_from, 'array');
                  };
                  ...
                  ?>
                      <div class="f_l">
                        <b><?php if ($this->_var['comment']['comment_type'] == '0') : ?><?php echo $this->_var['lang']['goods_comment']; ?><?php else : ?><?php echo $this->_var['lang']['article_comment']; ?><?php endif; ?>: </b>
                        <font class="f4"><?php echo $this->_var['comment']['cmt_name']; ?></font>&nbsp;&nbsp;(<?php echo $this->_var['comment']['formated_add_time']; ?>)
                      </div>
                      <div class="f_r">
                  ...
                  unset($_from); ?><?php $this->pop_vars();; ?>
                    ...
                    <?php if ($this->_var['action'] == 'tag_list') : ?>
                      ...
                      <?php if ($this->_var['tags']) : ?>
                        ...
                        ?>
                            <a href="search.php?keywords=<?php echo urlencode($this->_var['tag']['tag_words']); ?>" class="f6"><?php echo htmlspecialchars($this->_var['tag']['tag_words']); ?></a> <a href="user.php?act=act_del_tag&amp;tag_words=<?php echo urlencode($this->_var['tag']['tag_words']); ?>" onclick="if (!confirm('<?php echo $this->_var['lang']['confirm_drop_tag']; ?>')) return false;" title="<?php echo $this->_var['lang']['drop']; ?>"><img src="themes/ecmoban_benlai2015/images/drop.gif" alt="<?php echo $this->_var['lang']['drop']; ?>" /></a>&nbsp;&nbsp;
                            <?php endforeach;
                        endif;
                        unset($_from); ?><?php $this->pop_vars();; ?>
                          <?php else : ?>
                        ...
                        <?php if ($this->_var['action'] == 'collection_list') : ?>
                          ...
                          <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
                            ...
                            <?php $_from = $this->_var['goods_list'];
                            if (!is_array($_from) && !is_object($_from)) {
                              settype($_from, 'array');
                            };
                            $this->push_vars('', 'goods');
                            if (count($_from)) :
                        ...
                        <?php if ($this->_var['action'] == 'booking_list') : ?>
                          ...
                          <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
                            ...
                            <?php $_from = $this->_var['booking_list'];
                            if (!is_array($_from) && !is_object($_from)) {
                              settype($_from, 'array');
                            };
                            $this->push_vars('', 'item');
                        ...
                        <?php if ($this->_var['action'] == 'add_booking') : ?>
                          ...
                          <script type="text/javascript">
                            <?php $_from = $this->_var['lang']['booking_js'];
                            if (!is_array($_from) && !is_object($_from)) {
                              settype($_from, 'array');
                            };
                            ...
                            <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
                              ...
                              <tr>
                                ...
                                <td bgcolor="#ffffff"><input name="act" type="hidden" value="act_add_booking" />
                                  ...
                                  <input type="submit" name="submit" class="submit" value="<?php echo $this->_var['lang']['submit_booking_goods']; ?>" style=" line-height:25px" />
                                  <input type="reset" name="reset" class="reset" value="<?php echo $this->_var['lang']['button_reset']; ?>" style=" line-height:25px" />
                                </td>
                              </tr>
                            </table>
                          </form>
                            ...
                            <?php if (!$this->_var['goodsid'] || $this->_var['goodsid'] == 0) : ?>
                              ...
                              <?php if ($this->_var['affiliate']['config']['separate_by'] == 0) : ?>
                                ...
                                <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
                                  ...
                                  <?php $_from = $this->_var['affdb'];
                                  if (!is_array($_from) && !is_object($_from)) {
                                    settype($_from, 'array');
                                  };
                                  $this->push_vars('level', 'val');
                                  $this->_foreach['affdb'] = array('total' => count($_from), 'iteration' => 0);
                              ...
                              <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
                                ...
                                <?php $_from = $this->_var['logdb'];
                                if (!is_array($_from) && !is_object($_from)) {
                                  settype($_from, 'array');
                                };
                                $this->push_vars('', 'val');
                                $this->_foreach['logdb'] = array('total' => count($_from), 'iteration' => 0);
...
<script type="text/javascript">
  <?php $_from = $this->_var['lang']['clips_js'];
  if (!is_array($_from) && !is_object($_from)) {
    settype($_from, 'array');
  };
  $this->push_vars('key', 'item');
