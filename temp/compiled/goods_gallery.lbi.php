<?php if ($this->_var['pictures']) : ?>
  <div class="picture" id="imglist">
    ...
    <?php $_from = $this->_var['pictures'];
    if (!is_array($_from) && !is_object($_from)) {
      settype($_from, 'array');
    };
    $this->push_vars('', 'picture');
    ...
    ?>
        ...
        <?php if ($this->_foreach['no']['iteration'] < 2) : ?>
          ...
          <a href="<?php echo $this->_var['picture']['img_url']; ?>" rel="zoom1" rev="<?php echo $this->_var['picture']['img_url']; ?>" title="<?php echo htmlspecialchars($this->_var['picture']['img_desc']); ?>">
