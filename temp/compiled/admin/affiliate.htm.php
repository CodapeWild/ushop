<?php if ($this->_var['full_page']) : ?>
  ...
  <div id="separate">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="4">
          ...
          <tr>
            ...
            <td><input type="text" name="level_point_all" maxlength="150" size="10" value="<?php echo $this->_var['config']['config']['level_point_all']; ?>" />
              <br />
              <span class="notice-span" <?php if ($this->_var['help_open']) : ?>style="display:block" <?php else : ?> style="display:none" <?php endif; ?> id="notice2"><?php echo nl2br($this->_var['lang']['help_lpa']); ?></span>
            </td>
          </tr>
          <tr>
            ...
            <td><input type="text" name="level_money_all" maxlength="150" size="10" value="<?php echo $this->_var['config']['config']['level_money_all']; ?>" />
              <br />
              <span class="notice-span" <?php if ($this->_var['help_open']) : ?>style="display:block" <?php else : ?> style="display:none" <?php endif; ?> id="notice3"><?php echo nl2br($this->_var['lang']['help_lma']); ?></span>
            </td>
          </tr>
          <tr>
            ...
            <td><input type="text" name="level_register_all" maxlength="150" size="10" value="<?php echo $this->_var['config']['config']['level_register_all']; ?>" />
              <br />
              <span class="notice-span" <?php if ($this->_var['help_open']) : ?>style="display:block" <?php else : ?> style="display:none" <?php endif; ?> id="notice4"><?php echo nl2br($this->_var['lang']['help_lra']); ?></span>
            </td>
          </tr>
          <tr>
            ...
            <td><input type="text" name="level_register_up" maxlength="150" size="10" value="<?php echo $this->_var['config']['config']['level_register_up']; ?>" />
              <br />
              <span class="notice-span" <?php if ($this->_var['help_open']) : ?>style="display:block" <?php else : ?> style="display:none" <?php endif; ?> id="notice5"><?php echo nl2br($this->_var['lang']['help_lru']); ?></span>
            </td>
          <tr>
            <td></td>
    ...
    <table cellspacing='1' cellpadding='3'>
      ...
      <?php $_from = $this->_var['config']['item'];
      if (!is_array($_from) && !is_object($_from)) {
        settype($_from, 'array');
      };
      $this->push_vars('', 'val');
      $this->_foreach['nav'] = array('total' => count($_from), 'iteration' => 0);
