...
<div class="main-div">
  <table class="tb tb2">
    <tr>
      <th colspan="15"><?php echo $this->_var['lang']['filecheck_completed']; ?></th>
    </tr>
    <tr>
      <td colspan="4">
        <div class="lightfont filenum left">
          <!-- <?php $_from = $this->_var['result'];
                if (!is_array($_from) && !is_object($_from)) {
                  settype($_from, 'array');
                };
                $this->push_vars('files', 'nums');
                if (count($_from)) :
    ...
    <tr>
      <th><?php echo $this->_var['lang']['filename']; ?></th>
      <th><?php echo $this->_var['lang']['filesize']; ?></th>
      <th><?php echo $this->_var['lang']['filemtime']; ?></th>
      <th><?php echo $this->_var['lang']['filecheck_status']; ?></th>
    </tr>
    <!-- <?php $_from = $this->_var['dirlog'];
            if (!is_array($_from) && !is_object($_from)) {
              settype($_from, 'array');
            };
            $this->push_vars('dir', 'status');
            if (count($_from)) :
    ...
    <tr>
      <td colspan="4">
        ...
        <!-- <?php $_from = $this->_var['status'];
                if (!is_array($_from) && !is_object($_from)) {
                  settype($_from, 'array');
                };
                $this->push_vars('type', 'nums');
                if (count($_from)) :
    ...
    <tbody id="<?php echo $this->_var['status']['marker']; ?>">
      ...
      <!-- <?php $_from = $this->_var['files'];
            ...
            ?> -->
      <tr>
        <td> <em class="bold files"><?php echo $this->_var['file']['file']; ?></em></td>
        <td><?php echo $this->_var['file']['size']; ?></td>
        <td><?php echo $this->_var['file']['filemtime']; ?></td>
        <td><?php echo $this->_var['file']['status']; ?></td>
      </tr>
      <!-- <?php endforeach;
                      endif;
                      unset($_from); ?><?php $this->pop_vars();; ?> -->
