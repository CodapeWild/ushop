    ...
    <table cellspacing='1' cellpadding='3' id='list-table'>
      <tr>
        <th><input onclick='listTable.selectAll(this, "checkboxes")' type="checkbox">
          <a href="javascript:listTable.sort('article_id'); "><?php echo $this->_var['lang']['article_id']; ?></a><?php echo $this->_var['sort_article_id']; ?>
        </th>
      ...
      <?php $_from = $this->_var['article_list'];
      ...
      ?>
          <tr>
            ...
            <td class="first-cell">
              <span onclick="javascript:listTable.edit(this, 'edit_title', <?php echo $this->_var['list']['article_id']; ?>)"><?php echo htmlspecialchars($this->_var['list']['title']); ?></span>
            </td>
            <td align="left"><span>
                <!-- <?php if ($this->_var['list']['cat_id'] > 0) : ?> --><?php echo htmlspecialchars($this->_var['list']['cat_name']); ?>
                <!-- <?php else : ?> --><?php echo $this->_var['lang']['reserve']; ?>
                <!-- <?php endif; ?> -->
              </span></td>
            ...
            <td align="center" nowrap="true"><span>
                ...
                <!-- <?php if ($this->_var['list']['cat_id'] > 0) : ?> --><a href="javascript:;" onclick="listTable.remove(<?php echo $this->_var['list']['article_id']; ?>, '<?php echo $this->_var['lang']['drop_confirm']; ?>')" title="<?php echo $this->_var['lang']['remove']; ?>"><img src="images/icon_drop.gif" border="0" height="21" width="21"></a><!-- <?php endif; ?> -->
              </span>
            </td>
          </tr>
        <?php endforeach;
        ...
        <tr>
          <td class="no-records" colspan="10"><?php echo $this->_var['lang']['no_article']; ?></td>
        </tr>
        <?php endif;
