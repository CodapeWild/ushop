...
<div class="list-div">
  <table width="100%" cellpadding="3" cellspacing="1">
    <tr>
      <th><?php echo $this->_var['lang']['current_template']; ?></th>
    </tr>
    <tr>
      <td>
        <table>
          <tr>
            ...
            <td valign="top"><strong><span id="templateName"><?php echo $this->_var['curr_template']['name']; ?></span></strong> v<span id="templateVersion"><?php echo $this->_var['curr_template']['version']; ?></span><br />
              ...
              <div id="CurrTplStyleList">
                <?php $_from = $this->_var['template_style'][$this->_var['curr_template']['code']];
                if (!is_array($_from) && !is_object($_from)) {
                  settype($_from, 'array');
                };
                $this->push_vars('', 'curr_style');
    ...
    <tr>
      <th><?php echo $this->_var['lang']['available_templates']; ?></th>
    </tr>
    <tr>
      <td>
        <?php $_from = $this->_var['available_templates'];
        if (!is_array($_from) && !is_object($_from)) {
          settype($_from, 'array');
        };
        $this->push_vars('', 'template');
        if (count($_from)) :
        ...
        ?>
            <div style="display:-moz-inline-stack;display:inline-block;vertical-align:top;zoom:1;*display:inline;">
              <table style="width: 220px;">
                ...
                <tr>
                  <td valign="top">
                    <?php $_from = $this->_var['template_style'][$this->_var['template']['code']];
                    if (!is_array($_from) && !is_object($_from)) {
                      settype($_from, 'array');
                    };
                    $this->push_vars('', 'style');
                    $this->_foreach['foo1'] = array('total' => count($_from), 'iteration' => 0);
