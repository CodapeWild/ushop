...
<div class="tab-div">
  ...
  <div class="tab-body">
    ...
    <div class="list-div list-div-ad" style="margin-top:15px;">
      <table>
        <tr>
          <th><?php echo $this->_var['lang']['flash_template']; ?></th>
        </tr>
        <tr>
          <td><?php $_from = $this->_var['flashtpls'];
              if (!is_array($_from) && !is_object($_from)) {
                settype($_from, 'array');
              };
              $this->push_vars('', 'flashtpl');
              if (count($_from)) :
              ...
              ?>
                <table style="float:left;width: 220px;">
                  <tr>
                    <td><strong>
                        <center><?php echo $this->_var['flashtpl']['name']; ?>&nbsp;<?php if ($this->_var['flashtpl']['code'] == $this->_var['current_flashtpl']) : ?><span style="color:red;" id="current_theme"><?php echo $this->_var['lang']['current_theme']; ?></span><?php endif; ?></center>
                      </strong></td>
                  </tr>
                  <tr>
