...
<head>
  ...
  <style type="text/css">
    ...
    .ico_1 {
      background: #1480b3 url(images/menu_1.png) 9px center no-repeat;
    }

    .ico_2 {
      background: #1480b3 url(images/menu_2.png) 9px center no-repeat;
    }

    .ico_3 {
      background: #1480b3 url(images/menu_3.png) 9px center no-repeat;
    }

    .ico_4 {
      background: #1480b3 url(images/menu_4.png) 9px center no-repeat;
    }

    .ico_5 {
      background: #1480b3 url(images/menu_5.png) 9px center no-repeat;
    }

    .ico_6 {
      background: #1480b3 url(images/menu_6.png) 9px center no-repeat;
    }

    .ico_7 {
      background: #1480b3 url(images/menu_7.png) 9px center no-repeat;
    }

    .ico_8 {
      background: #1480b3 url(images/menu_8.png) 9px center no-repeat;
    }

    .ico_9 {
      background: #1480b3 url(images/menu_9.png) 9px center no-repeat;
    }

    .ico_10 {
      background: #1480b3 url(images/menu_10.png) 9px center no-repeat;
    }

    .ico_11 {
      background: #1480b3 url(images/menu_11.png) 9px center no-repeat;
    }

    .ico_12 {
      background: #1480b3 url(images/menu_12.png) 9px center no-repeat;
    }

    .ico_13 {
      background: #1480b3 url(images/menu_13.png) 9px center no-repeat;
    }

    .ico_14 {
      background: #1480b3 url(images/menu_14.png) 9px center no-repeat;
    }

    .ico_15 {
      background: #1480b3 url(images/menu_15.png) 9px center no-repeat;
    }

    .ico_16 {
      background: #1480b3 url(images/menu_16.png) 9px center no-repeat;
    }


    .ico2_1 {
      background: #1480b3 url(images/menu1_1.png) 9px 0px no-repeat;
    }

    .ico2_2 {
      background: #1480b3 url(images/menu1_2.png) 9px 0px no-repeat;
    }

    .ico2_3 {
      background: #1480b3 url(images/menu1_3.png) 9px 0px no-repeat;
    }

    .ico2_4 {
      background: #1480b3 url(images/menu1_4.png) 9px 0px no-repeat;
    }

    .ico2_5 {
      background: #1480b3 url(images/menu1_5.png) 9px 0px no-repeat;
    }

    .ico2_6 {
      background: #1480b3 url(images/menu1_6.png) 9px 0px no-repeat;
    }

    .ico2_7 {
      background: #1480b3 url(images/menu1_7.png) 9px 0px no-repeat;
    }

    .ico2_8 {
      background: #1480b3 url(images/menu1_8.png) 9px 0px no-repeat;
    }

    .ico2_9 {
      background: #1480b3 url(images/menu1_9.png) 9px 0px no-repeat;
    }

    .ico2_10 {
      background: #1480b3 url(images/menu1_10.png) 9px 0px no-repeat;
    }

    .ico2_11 {
      background: #1480b3 url(images/menu1_11.png) 9px 0px no-repeat;
    }

    .ico2_12 {
      background: #1480b3 url(images/menu1_12.png) 9px 0px no-repeat;
    }

    .ico2_13 {
      background: #1480b3 url(images/menu1_13.png) 9px 0px no-repeat;
    }

    .ico2_14 {
      background: #1480b3 url(images/menu1_14.png) 9px 0px no-repeat;
    }

    .ico2_15 {
      background: #1480b3 url(images/menu1_15.png) 9px 0px no-repeat;
    }

    .ico2_16 {
      background: #1480b3 url(images/menu1_16.png) 9px 0px no-repeat;
    }
...
<body>
              ...
              <li class="collapse lis ico_<?php echo $this->_foreach['foo']['iteration']; ?>" key="<?php echo $this->_var['k']; ?>" name="menu" key_data1="lis ico_<?php echo $this->_foreach['foo']['iteration']; ?>" key_data2="lis ico2_<?php echo $this->_foreach['foo']['iteration']; ?>">
                ...
                <?php if ($this->_var['menu']['children']) : ?>
                  <ul style="display:none;">
                    <?php $_from = $this->_var['menu']['children'];
                    if (!is_array($_from) && !is_object($_from)) {
                      settype($_from, 'array');
                    };
                    $this->push_vars('', 'child');
                    if (count($_from)) :
  ...
  <script language="JavaScript">
    ...
    var getClass = function(name) {
      var ele = document.getElementById("menu-ul").getElementsByTagName("li"),
        arr = [];
    ...
    function toggleCollapseExpand(obj, status) {
      ...
      var ie = /ie 7/i.test(navigator.userAgent),
        dis = null;
    ...
    function start_menu_api(result) {
      if (result.content == 0) {} else {
        ...
        var arr = [{
          key_data1: "lis ico_15",
          key_data2: "lis ico2_15"
        }, {
