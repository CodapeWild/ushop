...
<div class="form-div">
  <form name="sqlFrom" method="post" action="sql.php" onsubmit="return validate()">
    <table>
      ...
      <tr>
        <td><span style="color: rgb(255, 0, 0);"><strong><?php echo $this->_var['lang']['note']; ?></strong></span></td>
      </tr>
      <tr>
        <td><textarea name="sql" rows="6" cols="80"><?php echo $this->_var['sql']; ?></textarea></td>
      </tr>
      <tr>
        <td><input type="hidden" name="act" value="query"><input value="<?php echo $this->_var['lang']['query']; ?>" type="submit" class="button" /></td>
      </tr>
    </table>
  </form>
</div>
...
<div class="list-div" id="listDiv">
  ...
  <?php if ($this->_var['type'] == 1) : ?>
    <!-- 执行成功-->
    <center>
      <h3><?php echo $this->_var['lang']['succeed']; ?></h3>
    </center>
  <?php endif; ?>
